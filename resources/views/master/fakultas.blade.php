...
<div class="master-data-container">
    <div id="listContainer" class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center ml-auto" style="gap: 8px;">
                ...
                <a class="btn btn-sm btn-outline-secondary" href="{{ route('master.fakultas.template') }}">
    ...
    <div class="modal fade" id="modalImport" tabindex="-1">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header header-white">
                    <h5 class="modal-title" id="importModalTitle"><i class="fas fa-file-excel mr-2"></i>Preview Import Fakultas</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body" style="position: relative;">
                    ...
                    <div id="importPreviewWrap">
                        <div class="alert alert-info py-2 small mb-3">
                            ...
                            <span class="badge badge-danger">Tidak Valid</span> kode atau nama fakultas tidak sesuai master.
                        </div>
                            ...
                            <table class="table table-bordered table-sm align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:200px;">Kode Fakultas</th>
                                        <th>Nama Fakultas</th>
...
<script>
    ...
    function uploadImport(input) {
        ...
        fetch('{{ route("master.fakultas.import-preview") }}', {
            ...
            document.getElementById('importModalTitle').innerHTML = '<i class="fas fa-file-excel mr-2"></i>Preview Import Fakultas';
    ...
    function renderImportResult(data) {
        ...
        document.getElementById('importModalTitle').innerHTML = '<i class="fas fa-clipboard-check mr-2"></i>Hasil Import Fakultas';
