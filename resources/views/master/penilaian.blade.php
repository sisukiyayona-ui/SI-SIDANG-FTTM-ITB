    ...
    <div id="formContainer" class="card" style="display: none;">
        ...
        <div class="card-body">
            <form id="mainForm" method="POST">
                ...
                <div class="mb-3">
                    <label for="f_nama" class="form-label">Parameter Penilaian</label>
                    <input type="text" name="nama" id="f_nama" class="form-control" placeholder="Nama parameter komponen" required>
                </div>
                <div class="mb-3">
                    <label for="f_tahapan_sidang" class="form-label">Tahapan Sidang</label>
                ...
                <div class="mb-3">
                    <label for="f_strata" class="form-label">Strata</label>
                ...
                @if(session('auth_user.role') === 'Admin')
                    <div class="mb-3">
                        <label for="f_id_prodi" class="form-label">Program Studi</label>
...
@push('scripts')
<script>
    const nilaiData = @json($penilaian);
    ...
    function openEdit(id) {
        const item = nilaiData.find(p => p.id === id);
        if (!item) return;
